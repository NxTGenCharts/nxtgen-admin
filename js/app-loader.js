/* ══════════════════════════════════════════════════════════════════════
   AppLoader — reusable global Loading Manager (Admin console build)
   ──────────────────────────────────────────────────────────────────────
...
(function () {
  ...
  try { isReturningVisit = sessionStorage.getItem('nxtgen_admin_booted') === '1'; } catch (e) {}
      ...
      setTimeout(function () {
        ...
        requestAnimationFrame(function () {
          requestAnimationFrame(function () {
            ...
            try { sessionStorage.setItem('nxtgen_admin_booted', '1'); } catch (e) {}
          });
        });
      }, delay);
    }
